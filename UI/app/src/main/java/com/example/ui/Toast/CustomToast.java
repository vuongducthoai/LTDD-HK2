...
public class CustomToast extends Toast {
    ...
    public static Toast makeText(Context context, String message, int duration, int type, boolean androidicon, int gravity, int xOffset, int yOffset,View.OnClickListener listener) {
